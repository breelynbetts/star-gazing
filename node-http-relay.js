...
var API_HOST = "https://eonet.sci.gsfc.nasa.gov/api/v2.1"; // Put your actual API host here.
...
app.use('/', function (req, res) {
    ...
    res.header("Access-Control-Allow-Origin", "https://eonet.sci.gsfc.nasa.gov/api/v2.1");
